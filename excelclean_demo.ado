...
di "Files of example 1 are saved under demo_bankscope/"
...
di "Files of example 2 are saved under demo_SNL/"
di `"Command Executed: excelclean , datadir("demo_SNL") sheet("Sheet1") cellrange("A2") pivot namerange("1 3") "'
